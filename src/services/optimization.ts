 ...
 */
export function calculatePriorityScore(prospect: Prospect): number {
  let score = 100;
 ...
 */
export function clusterProspects(
  prospects: Prospect[],
 ...
 */
export function optimizeRoute(prospects: Prospect[], startLat: number, startLng: number): Prospect[] {
  ...
  while (remaining.length > 0) {
    ...
    let nearest: Prospect | null = null;
 ...
 */
export function generateSmartCallingList(
  prospects: Prospect[],
  fieldRep: FieldRep
): Prospect[] {
