...
import { insertProspectSchema, insertFieldRepSchema, insertAppointmentSchema, insertStakeholderSchema, insertUserSchema, insertCallOutcomeSchema, insertIssueSchema } from "./db/schema";
import { createLinearIssue, getLinearIssues, getLinearTeams } from "./services/linear";
...
import { searchProfessionalsByLocation } from "./services/geocoding";
...
export async function registerRoutes(app) {
    ...
    app.get("/api/appointments/:fieldRepId/:date", async (req, res) => {
        try {
            const appointments = await storage.listAppointmentsByFieldRepAndDate(req.params.fieldRepId, req.params.date);
